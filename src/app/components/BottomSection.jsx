  ...
  return (
    <div className="socials flex flex-row gap-2">
      <Link className="mr-2" href="https://github.com/Gabrieloxe">
        <BsGithub className="h-10 w-10 text-[#ADB&BE] cursor-pointer" alt="github icon" />
      </Link>
      <Link href="https://www.linkedin.com/in/gabriel-ong-bb3494159/">
        <BsLinkedin className="h-10 w-10 text-[#ADB&BE] cursor-pointer" alt="Linked in icon" />
      </Link>
    </div>
  );
};
    ...
    >
      ...
      <div className="z-10 max-w-md">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-xl">
          I am currently happy with my job, but I am open to new opportunities in the software
          development field. If you have a role that you think I would be a good fit for feel free
          to reach out to me on linked in :D
        </p>
        <Socials />
      </div>
    </section>
