        ...
        >
            ...
            <div className="z-10 max-w-md">
                ...
                <p className="text-[#ADB7BE] mb-4 max-w-xl">
                    I am currently happy with my job, but I am open to new opportunities in the
                    software development field. If you have a role that you think I would be a good
                    fit for feel free to reach out to me on linked in :D
                </p>
                <Socials />
            </div>
        </section>
